/* Legal document templates for the Shlep site (EN/DE/FR/IT). Template only — not legal advice. */
window.SHLEP_LEGAL_UPDATED = "2026-07-04";
window.SHLEP_LEGAL_UI = {
  de: { back: "Zurück", terms: "AGB", privacy: "Datenschutz", impressum: "Impressum",
    updated: "Zuletzt aktualisiert", disclaimer: "Dieses Dokument ist eine unverbindliche Vorlage und stellt keine Rechtsberatung dar. Lass es von einer qualifizierten Schweizer Anwältin oder einem Anwalt prüfen, bevor du dich darauf verlässt." },
  fr: { back: "Retour", terms: "CGU", privacy: "Confidentialité", impressum: "Mentions légales",
    updated: "Dernière mise à jour", disclaimer: "Ce document est un modèle fourni à titre indicatif et ne constitue pas un conseil juridique. Faites-le vérifier par un avocat suisse qualifié avant de vous y fier." },
  it: { back: "Indietro", terms: "Condizioni", privacy: "Privacy", impressum: "Note legali",
    updated: "Ultimo aggiornamento", disclaimer: "Questo documento è un modello fornito a scopo pratico e non costituisce consulenza legale. Fallo verificare da un avvocato svizzero qualificato prima di farvi affidamento." },
  en: { back: "Back", terms: "Terms", privacy: "Privacy", impressum: "Legal notice",
    updated: "Last updated", disclaimer: "This document is a template provided for convenience and is not legal advice. Have it reviewed by a qualified Swiss lawyer before you rely on it." }
};

window.SHLEP_LEGAL = {
  en: {
    terms: { title: "Terms & Conditions",
      intro: "These terms govern your use of the Shlep app and the peer-to-peer delivery service it provides in Switzerland. By creating an account you accept them.",
      sections: [
        ...
        { h: "4. Payments and fees", p: "Payments are processed by our payment provider. Shlep charges a platform fee (currently 8.1% of the delivery price); the remainder is paid out to the driver after a code-verified delivery. Applicable taxes are your responsibility." },
    ...
    privacy: { title: "Privacy Policy",
      intro: "This policy explains how Shlep processes your personal data under the revised Swiss Federal Act on Data Protection (FADP) and, where applicable, the GDPR.",
      sections: [
  ...
  de: {
    terms: { title: "Allgemeine Geschäftsbedingungen",
      intro: "Diese Bedingungen regeln die Nutzung der Shlep-App und des darüber angebotenen Peer-to-Peer-Lieferdienstes in der Schweiz. Mit der Erstellung eines Kontos akzeptierst du sie.",
      sections: [
        ...
        { h: "4. Zahlungen und Gebühren", p: "Zahlungen werden über unseren Zahlungsdienstleister abgewickelt. Shlep erhebt eine Plattformgebühr (derzeit 8.1 % des Lieferpreises); der Rest wird nach einer per Code bestätigten Lieferung an die fahrende Person ausbezahlt. Anfallende Steuern liegen in deiner Verantwortung." },
    ...
    privacy: { title: "Datenschutzerklärung",
      intro: "Diese Erklärung beschreibt, wie Shlep deine Personendaten gemäss dem revidierten Schweizer Datenschutzgesetz (DSG) und, soweit anwendbar, der DSGVO bearbeitet.",
      sections: [
  ...
  fr: {
    terms: { title: "Conditions générales",
      intro: "Ces conditions régissent l'utilisation de l'application Shlep et du service de livraison entre particuliers proposé en Suisse. En créant un compte, vous les acceptez.",
      sections: [
        ...
        { h: "4. Paiements et frais", p: "Les paiements sont traités par notre prestataire de paiement. Shlep prélève une commission de plateforme (actuellement 8.1 % du prix de la livraison) ; le solde est versé au conducteur après une livraison confirmée par code. Les taxes applicables sont à votre charge." },
    ...
    privacy: { title: "Politique de confidentialité",
      intro: "Cette politique explique comment Shlep traite vos données personnelles conformément à la loi fédérale suisse révisée sur la protection des données (LPD) et, le cas échéant, au RGPD.",
      sections: [
  ...
  it: {
    terms: { title: "Condizioni generali",
      intro: "Queste condizioni regolano l'uso dell'app Shlep e del servizio di consegna tra privati offerto in Svizzera. Creando un account le accetti.",
      sections: [
        ...
        { h: "4. Pagamenti e commissioni", p: "I pagamenti sono elaborati dal nostro fornitore di pagamento. Shlep applica una commissione di piattaforma (attualmente l'8.1% del prezzo di consegna); il resto viene versato al conducente dopo una consegna confermata tramite codice. Le imposte applicabili sono a tuo carico." },
    ...
    privacy: { title: "Informativa sulla privacy",
      intro: "Questa informativa spiega come Shlep tratta i tuoi dati personali ai sensi della legge federale svizzera riveduta sulla protezione dei dati (LPD) e, ove applicabile, del GDPR.",
      sections: [
