...
window.SHLEP_LEGAL_UPDATED = "2026-07-21";
  ...
  en: {
    terms: { title: "Terms & Conditions",
      ...
      sections: [
        ...
        { h: "5. Conduct and liability", p: "You agree to act lawfully and respectfully. To the extent permitted by law, Shlep is not liable for loss or damage arising from the transport itself, which is a matter between sender and driver. Nothing excludes liability that cannot be excluded under Swiss law. Shlep does not provide transport insurance. What is protected is the payment: it is held until delivery is confirmed by code. Cash, jewellery, precious metals, identity documents and other valuables must not be sent." },
  ...
  de: {
    terms: { title: "Allgemeine Geschäftsbedingungen",
      ...
      sections: [
        ...
        { h: "5. Verhalten und Haftung", p: "Du verpflichtest dich zu rechtmässigem und respektvollem Verhalten. Soweit gesetzlich zulässig, haftet Shlep nicht für Verluste oder Schäden aus dem Transport selbst, der Sache zwischen sendender und fahrender Person ist. Zwingende gesetzliche Haftung bleibt unberührt. Shlep bietet keine Transportversicherung an. Abgesichert ist die Zahlung: Der Betrag wird bis zur per Code bestätigten Zustellung zurückbehalten. Bargeld, Schmuck, Edelmetalle, Ausweise und andere Wertgegenstände dürfen nicht versendet werden." },
  ...
  it: {
    terms: { title: "Condizioni generali",
      ...
      sections: [
        ...
        { h: "5. Comportamento e responsabilità", p: "Ti impegni ad agire in modo lecito e rispettoso. Nei limiti consentiti dalla legge, Shlep non è responsabile per perdite o danni derivanti dal trasporto stesso, che riguarda mittente e conducente. Resta salva la responsabilità imperativa di legge. Shlep non offre un'assicurazione sul trasporto. Ciò che è protetto è il pagamento: l'importo viene trattenuto fino alla consegna confermata con codice. Contanti, gioielli, metalli preziosi, documenti d'identità e altri oggetti di valore non devono essere spediti." },
