  ...
  en: {
    terms: { title: "Terms & Conditions",
      ...
      sections: [
        ...
        { h: "4. Payments and fees", p: "Payments are processed by our payment provider. Shlep charges a platform fee (currently 10% of the delivery price); the remainder is paid out to the driver after a code-verified delivery. Applicable taxes are your responsibility." },
  ...
  de: {
    terms: { title: "Allgemeine Geschäftsbedingungen",
      ...
      sections: [
        ...
        { h: "4. Zahlungen und Gebühren", p: "Zahlungen werden über unseren Zahlungsdienstleister abgewickelt. Shlep erhebt eine Plattformgebühr (derzeit 10 % des Lieferpreises); der Rest wird nach einer per Code bestätigten Lieferung an die fahrende Person ausbezahlt. Anfallende Steuern liegen in deiner Verantwortung." },
  ...
  fr: {
    terms: { title: "Conditions générales",
      ...
      sections: [
        ...
        { h: "4. Paiements et frais", p: "Les paiements sont traités par notre prestataire de paiement. Shlep prélève une commission de plateforme (actuellement 10 % du prix de la livraison) ; le solde est versé au conducteur après une livraison confirmée par code. Les taxes applicables sont à votre charge." },
  ...
  it: {
    terms: { title: "Condizioni generali",
      ...
      sections: [
        ...
        { h: "4. Pagamenti e commissioni", p: "I pagamenti sono elaborati dal nostro fornitore di pagamento. Shlep applica una commissione di piattaforma (attualmente il 10% del prezzo di consegna); il resto viene versato al conducente dopo una consegna confermata tramite codice. Le imposte applicabili sono a tuo carico." },
